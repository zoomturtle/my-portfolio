...
def lambda_handler(event, context):
    ...
    location = {
        "bucketName": 'portfoliobuild.dmbackup.com',
        "objectKey": 'portfoliobuild.dmbackup.com/portfoliobuild.zip'
    }
    try:
        ...
        build_bucket.download_fileobj(location["objectKey"], portfoliobuild_zip)
